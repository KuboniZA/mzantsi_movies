      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 80 }}>
        <View>
          ...
          <View className="flex-col items-start justify-center mt-5 px-5">
            <Text className="text-white font-cold text-xl">{movie?.title}</Text>
            <View className="flex-row items-center gap-x-1 mt-2">
              <Text className="text-light-200 text">
                {movie?.release_date?.split("-")[0]}
              </Text>
              <Text className="text-light-200 text">{movie?.runtime}m</Text>
            </View>
            ...
            />
            <View className="flex flex-row w-1/2 gap-10">
              <MovieInfo
                label="Budget"
              ...
              <MovieInfo
                label="Revenue"
                value={formattedMoney(movie?.revenue)}
              />
            </View>
            <MovieInfo
